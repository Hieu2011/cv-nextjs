  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        top-0 left-0 w-full p-2 pr-2.5 ease-[cubic-bezier(0.22,1,0.36,1)]
        ...
        **:data-[slot=navigation-menu-link]:focus:outline-none md:absolute
        md:w-auto`,
        className
      )}
      {...props}
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          ring-foreground/10 data-open:animate-in data-open:zoom-in-90
          data-closed:animate-out data-closed:zoom-out-90 relative mt-1.5
          h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden
          rounded-lg shadow ring-1 duration-100
